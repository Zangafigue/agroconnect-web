...
import transportHero from '../../assets/images/transport-hero.png';
  ...
  return (
    <div className="min-h-screen bg-white text-[#111827]">
      ...
      <main>
        {/* Hero Section */}
        <section 
          className="pt-40 pb-32 bg-cover bg-center text-white relative overflow-hidden"
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
            ...
            <h1 className="text-6xl md:text-9xl font-serif-display mb-10 tracking-tight leading-[0.9]">
              Vos camions,<br /><span className="italic text-green-400">Notre moteur.</span>
            </h1>
            ...
            <button 
              ...
              className="px-12 py-5 bg-white text-black font-bold rounded-2xl hover:bg-primary transition-all text-lg flex items-center justify-center gap-3 mx-auto"
            >
        ...
        <section className="py-32 max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="p-10 bg-[#f9fafb] rounded-[2rem] border border-gray-100 hover:border-green-600 transition-all group overflow-hidden relative shadow-sm hover:shadow-xl">
        ...
        <section className="py-32 bg-white border-y border-gray-100 overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div>
              <h2 className="text-5xl font-serif-display mb-12 tracking-tight leading-[1.1]">Comment rejoindre <br/><span className="italic text-primary">le convoi</span> ?</h2>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-6 p-6 rounded-2xl hover:bg-gray-50 transition-all border border-transparent hover:border-gray-100">
                    <div className="w-10 h-10 bg-green-600 text-white rounded-lg flex items-center justify-center shrink-0 font-bold text-sm shadow-md">
                      {i+1}
                    </div>
                    <div>
            ...
            <div className="relative">
               <div className="bg-[#14532d] rounded-[3rem] p-16 md:p-20 relative overflow-hidden text-center text-white">
                  <BadgeCheck size={80} className="text-primary mb-8 mx-auto" />
